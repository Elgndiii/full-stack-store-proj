...
.psuccess h2{ border-bottom: 1px solid #ddd; margin-bottom: 20px; padding-bottom: 10px;color: white; }	
.psuccess p{line-height:25px; font-size:18px; text-align: left;color: white; }
 </style>
<div class="main">
	<div class="content">
